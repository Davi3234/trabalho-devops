...
public class OrderEventPublisher {
    ...
    public void publishOrderCreated(Order order) {
        publish("pedido.criado", buildPayload(order));
    }

    public void publishOrderCancelled(Order order) {
        publish("pedido.cancelado", buildPayload(order));
    }

    public void publishOrderPaid(Order order) {
        publish("pedido.pago", buildPayload(order));
    }

    public void publishOrderDispatched(Order order) {
        publish("pedido.despachado", buildPayload(order));
    }
